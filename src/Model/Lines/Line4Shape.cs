...
namespace Draw.src.Model.Lines
{
    ...
    class Line4Shape : Shape
    {
        ...
        public Line4Shape(RectangleF rect) : base(rect) { }

        public Line4Shape(Line4Shape line) : base(line) { }
        ...
        public override void DrawSelf(Graphics grfx)
        {
            ...
            PointF point2 = new PointF(Rectangle.X, Rectangle.Y + Rectangle.Height);
